...
void cProtocol180::WriteMobMetadata(cPacketizer & a_Pkt, const cMonster & a_Mob)
{
	...
	switch (a_Mob.GetMobType())
	{
		...
		case mtHorse:
		{
			...
			a_Pkt.WriteBEInt16(Horse.GetAge());
			break;
		}  // case mtHorse
		...
		case mtOcelot:
		{
			...
			a_Pkt.WriteBEUInt8(0x0c);
			a_Pkt.WriteBEInt16(Ocelot.GetAge());
			break;
		}  // case mtOcelot
		...
		case mtSheep:
		{
			...
			a_Pkt.WriteBEUInt8(0x0c);
			a_Pkt.WriteBEInt16(Sheep.GetAge());
		...
		case mtRabbit:
		{
			...
			a_Pkt.WriteBEUInt8(0x0c);
			a_Pkt.WriteBEInt16(Rabbit.GetAge());
			break;
		}  // case mtRabbit
		...
		case mtVillager:
		{
			...
			a_Pkt.WriteBEUInt8(0x0c);
			a_Pkt.WriteBEInt16(Villager.GetAge());
			break;
		}  // case mtVillager
		...
		case mtWolf:
		{
			...
			a_Pkt.WriteBEUInt8(0x0c);
			a_Pkt.WriteBEInt16(Wolf.GetAge());
			break;
		}  // case mtWolf
